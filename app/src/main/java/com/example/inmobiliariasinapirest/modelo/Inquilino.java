...
public class Inquilino implements Serializable {
    ...
    public Inquilino(int id, String DNI, String nombre, String apellido, String lugarDeTrabajo, String email, String telefono, String nombreGarante, String telefonoGarante) {
        this.id = id;
        this.dni = DNI;
        this.nombre = nombre;
